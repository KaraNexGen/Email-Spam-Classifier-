"""
ESIS Final Web Application
=========================
A working web application for ESIS
"""
...
import os
import uuid
from esis_final import SimpleESIS, create_demo_dataset

app = Flask(__name__)
app.secret_key = 'esis_final_secret_key_2024'
CORS(app)
...
def init_esis():
    ...
    if os.path.exists('esis_final_model.pkl'):
        try:
...
def train_demo_model():
    ...
    esis.save_model('esis_final_model.pkl')
...
if __name__ == '__main__':
    print("Starting Email Security Intelligence System (ESIS) - Final Version")
    print("=" * 70)
